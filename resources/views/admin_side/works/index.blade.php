            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a class="btn btn-outline-primary" href="{{ route('works.create') }}"><i class="fa fa-plus"
                                aria-hidden="true"></i> Previous Work</a>
                ...
                <div class="card-body">
                    ...
                    <table id="$works_table" class="table table-striped table-hover table-inverse ">
                        ...
                        <tbody>
                            @foreach ($works as $work)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('works.show', $work->id) }}" class="btn btn-info btn-sm"><i
                                                class="fas fa-eye"></i> View</a>
                                        {{-- <a href="{{ route('$works.edit', $work->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i> Edit</a>
                            <a href="#"
                            data-delete-$work="{{ $work->id }}"
